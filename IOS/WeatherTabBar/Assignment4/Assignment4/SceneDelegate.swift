...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
  ...
  func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
    ...
    vanVC.tabBarItem = UITabBarItem(title: vancouver.name, image: UIImage(named: "canada"), selectedImage: nil)
    let verVC = CityViewController()
    verVC.city = verona
    verVC.tabBarItem = UITabBarItem(title: verona.name, image: UIImage(named: "italy"), selectedImage: nil)
    let tokVC = CityViewController()
    tokVC.city = tokyo
    tokVC.tabBarItem = UITabBarItem(title: tokyo.name, image: UIImage(named: "japan"), selectedImage: nil)
    let spVC = CityViewController()
    spVC.city = saoPaulo
    spVC.tabBarItem = UITabBarItem(title: saoPaulo.name, image: UIImage(named: "brazil"), selectedImage: nil)
    let seoulVC = CityViewController()
    seoulVC.city = seoul
    seoulVC.tabBarItem = UITabBarItem(title: seoul.name, image: UIImage(named: "skorea"), selectedImage: nil)
